  ...
  return (
    ...
    >
      <div className="page-container">
        ...
        <div className="flex items-center justify-between insights-header-container" style={{ marginBottom: '40px' }}>
          <style>{`
            ...
            @media (max-width: 767px) {
              ...
              .insights-header-container { align-items: center !important; flex-wrap: nowrap !important; }
              .view-all-text { font-size: 16px !important; height: auto !important; }
            }
          `}</style>
          <h2
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-[40px] md:gap-5" style={{ marginBottom: '40px' }}>
          {topBlogs.map((blog) => (
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-[40px] md:gap-5">
